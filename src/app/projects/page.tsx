...
function ProjectsPageContent() {
  ...
  return (
    ...
    >
      ...
      {/* Selected Employee Current Projects & Goals */}
      {selectedEmployee && (() => {
        const employee = employees.find(emp => emp.id === selectedEmployee)
        return employee ? (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <Card className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900 dark:to-indigo-900 border-purple-200 dark:border-purple-700">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-purple-900 dark:text-purple-100">
                  <UserGroupIcon className="h-6 w-6" />
                  {employee.firstName} {employee.lastName}'s Current Projects & Goals
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      ...
                      Current Projects ({employee.projects.length})
                    </h3>
                    <div className="space-y-3">
                      {employee.projects.map((project, index) => (
                        <div key={project.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              ...
                              project.status === 'active' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' :
                      ...
                      {employee.projects.length === 0 && (
                        <p className="text-gray-500 dark:text-gray-400 text-sm italic">No projects assigned</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      ...
                      Current Goals ({employee.goals.length})
                    </h3>
                    <div className="space-y-3">
                        ...
                        <div key={goal.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              ...
                              goal.status === 'in-progress' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' :
                              'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300'
                            }`}>
                              {goal.status === 'in-progress' ? 'pending' : goal.status}
                            </span>
                          </div>
                      ...
                      {employee.goals.length === 0 && (
                        <p className="text-gray-500 dark:text-gray-400 text-sm italic">No goals assigned</p>
                      )}
                    </div>
                  </div>
                </div>
